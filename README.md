...
capture_id)` query pair, by immutable capture-record ID, or as the focused relation for one
snapshot. There is intentionally no archive-wide capture listing or pagination surface yet.

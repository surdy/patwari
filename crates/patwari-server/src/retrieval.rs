...
use crate::{
    contract::{
        ...
        Compression, Manifest, PageHighWatermark, PaginatedResponse, Receipt,
        SessionLatestSnapshot, SessionResponse, SnapshotCapturesResponse, SnapshotResponse,
        SnapshotSummary,
    },
    database,
    error::ApiError,
...
fn filter_hash<T: Serialize>(kind: &str, filters: &T) -> Result<String, ApiError> {
